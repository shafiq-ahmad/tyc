...
<h4 class="veh_headings"><span class="inventory_headings"><?php echo Localize::_('brand_new_vehicles');?></span>
<a href="<?php echo Route::_('index.php?com=vehicles&view=vehicles&new=1');?>" class="btn btn-sm btn-warning"><?php echo Localize::_('view_all');?></a></h4>
...
foreach($latest_vehicles as $value): ?>
<li>
<div class="single_vehicle" id="single_vehicle<?php echo $value['id']?>">
<a href="<?php echo Route::_('?com=vehicles&view=vehicle&id=' . $value['id']);?>" style="margin-bottom:.2em;">
<?php 
