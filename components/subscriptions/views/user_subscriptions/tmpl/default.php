...
?></div>
	<div>
		<span class=""><a href="index.php?com=shipping&view=subscriptions&task=edit" class="btn btn-info btn-flat" tabindex="-1" ><i class="fa fa-circle-o"></i> <?php echo Localize::_('buy_subscription'); ?></a></span>
	</div>
<div class="com-head">
