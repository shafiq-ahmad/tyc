...
?></div>
	<div>
		<span><a href="index.php?com=shipping&view=port&task=edit" class="btn btn-info btn-flat btn-sm" tabindex="-1" ><i class="fa fa-circle-o"></i> New</a></span>
	</div>
	...
	<table id="data-table" class="table">
		<thead><tr><th>ID#</th><th>Country</th><th>Port</th><th>Actions</th></tr></thead>
		...
		?><tr <?php if($this->id==$row['id']){echo ' class="active"';} ?>><?php 
			...
			$add_city_link = "?com=shipping&view=port_cities&task=cities&port_id={$row['id']}";
			echo '<td>'; 
				echo '<a class="btn btn-info btn-sm" href="' . $add_city_link . '" title="Add city"><i class="fa fa-edit"></i>Assign cities</a>'; 
