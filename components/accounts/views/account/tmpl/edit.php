...
<div class="com-head">
	...
	<form class="form-inline" method="post" name="frm" action="?com=accounts&view=account&task=edit&id=<?php echo $this->id;?>">
		<fieldset class="form">
			<div class="form grid">
			...
			<div class="btn-group">
				...
				<span><a href="index.php?com=accounts&view=account" class="btn btn-info btn-flat btn-sm" tabindex="-1" ><i class="fa fa-list-ol"></i> Ports</a></span>
			</div>
			</div>
			</div>
		</fieldset>
