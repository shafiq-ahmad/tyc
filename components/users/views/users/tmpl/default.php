...
?></div>
		...
		<span class="hide"><a href="index.php?com=users&view=user&task=edit" class="btn btn-info btn-flat btn-sm" tabindex="-1" ><i class="fa fa-circle-o"></i> New</a></span>
	<?php /* ?><div></div><?php */?>
	...
	<table id="data-table" class="table">
		...
		?><tr <?php if($this->id==$row['id']){echo ' class="active"';} ?>><?php 
			...
			echo '<td>'; 
				...
				echo '&nbsp;&nbsp; | &nbsp;&nbsp;<a class="btn btn-danger btn-sm" href="#" onclick="return publishItem(' . $row['id'] . ",0,'" . $publish_link . "','" . 'Confirm Block' . '\')" title="Block"><i class="fa fa-hand-stop-o"></i></a>'; 
			echo '</td>'; 
		?></tr><?php
			}
		?></tbody>
