...
<div class="form-group"><select id="make_id" name="make_id" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('make'); ?></option><?php } 
echo HtmlForm::htmlSelectOptions($this->makes, $make_id, true);
?></select></div>
<div class="form-group"><select id="transmission" name="transmission" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('transmission'); ?></option><?php } 
echo HtmlForm::htmlSelectOptions($this->transmissions, $transmission, true);
?></select>
</div>
<div class="form-group"><select id="drive" name="drive" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('drive'); ?></option><?php } 
echo HtmlForm::htmlSelectOptions($this->drives, $drive, true);
?></select>
</div>
</div>
<div class="col-md-4">
<div class="form-group"><select id="year" name="year" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('year'); ?></option><?php } 
echo HtmlForm::htmlSelectOptions($this->years, $year, true);
?></select>
</div>
<div class="form-group"><select id="vehicle_condition" name="vehicle_condition" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('condition'); ?></option><?php } 
...
<div class="form-group"><select id="fuel_type" name="fuel_type" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('mileage'); ?></option><?php } 
echo HtmlForm::htmlSelectOptions($this->fuels, $fuel_type, true);
?></select>
</div>
<div class="form-group"><select id="engine" name="engine" class="form-control" <?php echo $disabled;?>><?php if(!$disabled){?><option value=""><?php echo Localize::_('engine'); ?></option><?php } 
