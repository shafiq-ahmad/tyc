...
<?php
if($id){
$veh_sql="SELECT v.*, u.full_name FROM vehicles AS v
...
<ul>
<li><span class="param"><?php echo Localize::_('seller') . Localize::_('profile');?></span><span class="span_detail"><a href="<?= 'index.php?com=users&view=public_profile&seller=' . $veh_value['user_id'];?>"><?php echo $veh_value['full_name'];?></a></span></li>
