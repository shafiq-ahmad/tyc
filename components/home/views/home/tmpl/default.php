...
<?php /*?>
<div id="rcjsload_d6b5b0"></div><script type="text/javascript">(function() {var referer="";try{if(referer=document.referrer,"undefined"==typeof referer||""==referer)throw"undefined"}catch(exception){referer=document.location.href,(""==referer||"undefined"==typeof referer)&&(referer=document.URL)}referer=referer.substr(0,700);var rcds = document.getElementById("rcjsload_d6b5b0");var rcel = document.createElement("script");rcel.id = 'rc_' + Math.floor(Math.random() * 1000);rcel.type = 'text/javascript';rcel.src = "https://thefirstnewspaper.com/servejs/?numberposts=6";rcel.async = true;rcds.appendChild(rcel);})();</script>
<?php //exit; ?>
<style>
div.home-btn{
	min-width:140px;
...
<a href="?com=articles&view=articles"><div class="home-btn wow zoomIn animated" style="visibility: visible; animation-name: zoomIn;">
